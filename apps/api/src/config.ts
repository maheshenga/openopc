...
const envSchema = z.object({
  ...
  // Additive OpenOPC developer-module distribution. The legacy Kortix-prefixed
  // names remain accepted so operators can upgrade the base without a flag cutover.
  OPENOPC_DEVELOPER_MODULE_DISTRIBUTION_ENABLED: z.string().optional(),
  KORTIX_DEVELOPER_MODULE_DISTRIBUTION_ENABLED: z.string().optional(),
  OPENOPC_DEVELOPER_MODULE_SIGNING_KEY_ID: optStr,
  KORTIX_DEVELOPER_MODULE_SIGNING_KEY_ID: optStr,
  OPENOPC_DEVELOPER_MODULE_SIGNING_PRIVATE_KEY_BASE64: optStr,
  KORTIX_DEVELOPER_MODULE_SIGNING_PRIVATE_KEY_BASE64: optStr,
  OPENOPC_DEVELOPER_MODULE_SIGNING_PUBLIC_KEY_BASE64: optStr,
  KORTIX_DEVELOPER_MODULE_SIGNING_PUBLIC_KEY_BASE64: optStr,
  ...
  OPENOPC_CLOUDFLARE_ACCOUNT_ID: optStr,
  OPENOPC_CLOUDFLARE_ZONE_ID: optStr,
  OPENOPC_CLOUDFLARE_CUSTOM_HOSTNAME_API_TOKEN: optStr,
  OPENOPC_MODULE_CUSTOM_HOSTNAME_TARGET: optStr,
  OPENOPC_MODULE_CUSTOM_HOSTNAME_ORIGIN: optHttpsOrigin(''),
  OPENOPC_MODULE_CUSTOM_HOSTNAME_SUFFIX: optStr,
  OPENOPC_MODULE_APP_BASE_DOMAIN: optStr,
  ...
  // OpenOPC developer artifact retention (leader-only, disabled by default).
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_ENABLED: optBoolFalse,
  // Scheduled run creation is hourly; queue polling stays at 5s so durable
  // acceptance-triggered runs are picked up within seconds of eligibility.
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_INTERVAL_MS: optInt(60 * 60_000),
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_RETRY_INTERVAL_MS: optInt(5_000),
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_LEASE_MS: optInt(60_000),
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_UPLOAD_BATCH_SIZE: optInt(50),
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_OBJECT_BATCH_SIZE: optInt(50),
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_ORPHAN_GRACE_MS: optInt(24 * 60 * 60_000),
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_MAX_ATTEMPTS: optInt(8),
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_RETRY_BASE_MS: optInt(1_000),
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_RETRY_MAX_MS: optInt(60 * 60_000),
...
export const config = {
  ...
  OPENOPC_DEVELOPER_MODULE_DISTRIBUTION_ENABLED:
    env.OPENOPC_DEVELOPER_MODULE_DISTRIBUTION_ENABLED,
  KORTIX_DEVELOPER_MODULE_DISTRIBUTION_ENABLED:
    env.KORTIX_DEVELOPER_MODULE_DISTRIBUTION_ENABLED,
  OPENOPC_DEVELOPER_MODULE_SIGNING_KEY_ID: env.OPENOPC_DEVELOPER_MODULE_SIGNING_KEY_ID,
  KORTIX_DEVELOPER_MODULE_SIGNING_KEY_ID: env.KORTIX_DEVELOPER_MODULE_SIGNING_KEY_ID,
  OPENOPC_DEVELOPER_MODULE_SIGNING_PRIVATE_KEY_BASE64:
    env.OPENOPC_DEVELOPER_MODULE_SIGNING_PRIVATE_KEY_BASE64,
  KORTIX_DEVELOPER_MODULE_SIGNING_PRIVATE_KEY_BASE64:
    env.KORTIX_DEVELOPER_MODULE_SIGNING_PRIVATE_KEY_BASE64,
  OPENOPC_DEVELOPER_MODULE_SIGNING_PUBLIC_KEY_BASE64:
    env.OPENOPC_DEVELOPER_MODULE_SIGNING_PUBLIC_KEY_BASE64,
  KORTIX_DEVELOPER_MODULE_SIGNING_PUBLIC_KEY_BASE64:
    env.KORTIX_DEVELOPER_MODULE_SIGNING_PUBLIC_KEY_BASE64,
  OPENOPC_MODULE_SERVICE_CAPABILITY_KEY_ID:
    env.OPENOPC_MODULE_SERVICE_CAPABILITY_KEY_ID,
  OPENOPC_MODULE_SERVICE_CAPABILITY_PRIVATE_KEY_BASE64:
  ...
  OPENOPC_CLOUDFLARE_ACCOUNT_ID: env.OPENOPC_CLOUDFLARE_ACCOUNT_ID,
  OPENOPC_CLOUDFLARE_ZONE_ID: env.OPENOPC_CLOUDFLARE_ZONE_ID,
  OPENOPC_CLOUDFLARE_CUSTOM_HOSTNAME_API_TOKEN:
    env.OPENOPC_CLOUDFLARE_CUSTOM_HOSTNAME_API_TOKEN,
  OPENOPC_MODULE_CUSTOM_HOSTNAME_TARGET: env.OPENOPC_MODULE_CUSTOM_HOSTNAME_TARGET,
  OPENOPC_MODULE_CUSTOM_HOSTNAME_ORIGIN: env.OPENOPC_MODULE_CUSTOM_HOSTNAME_ORIGIN,
  OPENOPC_MODULE_CUSTOM_HOSTNAME_SUFFIX: env.OPENOPC_MODULE_CUSTOM_HOSTNAME_SUFFIX,
  OPENOPC_MODULE_APP_BASE_DOMAIN: env.OPENOPC_MODULE_APP_BASE_DOMAIN,
  ...
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_ENABLED: env.OPENOPC_DEVELOPER_ARTIFACT_RETENTION_ENABLED,
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_INTERVAL_MS: env.OPENOPC_DEVELOPER_ARTIFACT_RETENTION_INTERVAL_MS,
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_RETRY_INTERVAL_MS: env.OPENOPC_DEVELOPER_ARTIFACT_RETENTION_RETRY_INTERVAL_MS,
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_LEASE_MS: env.OPENOPC_DEVELOPER_ARTIFACT_RETENTION_LEASE_MS,
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_UPLOAD_BATCH_SIZE: env.OPENOPC_DEVELOPER_ARTIFACT_RETENTION_UPLOAD_BATCH_SIZE,
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_OBJECT_BATCH_SIZE: env.OPENOPC_DEVELOPER_ARTIFACT_RETENTION_OBJECT_BATCH_SIZE,
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_ORPHAN_GRACE_MS: env.OPENOPC_DEVELOPER_ARTIFACT_RETENTION_ORPHAN_GRACE_MS,
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_MAX_ATTEMPTS: env.OPENOPC_DEVELOPER_ARTIFACT_RETENTION_MAX_ATTEMPTS,
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_RETRY_BASE_MS: env.OPENOPC_DEVELOPER_ARTIFACT_RETENTION_RETRY_BASE_MS,
  OPENOPC_DEVELOPER_ARTIFACT_RETENTION_RETRY_MAX_MS: env.OPENOPC_DEVELOPER_ARTIFACT_RETENTION_RETRY_MAX_MS,
