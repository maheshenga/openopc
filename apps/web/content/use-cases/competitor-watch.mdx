...
We watch our market with an agent that runs every day on OpenOPC. It checks
...
<Figure
  caption="The daily competitor summary posted to Slack"
  aspect="16/9"
/>
...
- **Isolation.** Each run executes in its own microVM sandbox, and only the Slack
  summary it's explicitly allowed to send leaves the sandbox.
...
<Figure
  caption="A pricing-page change flagged in the daily diff"
  aspect="16/9"
/>
