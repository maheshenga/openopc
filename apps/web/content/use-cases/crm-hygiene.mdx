...
We keep our HubSpot clean with an agent that runs every night on OpenOPC. It
...
<Figure
  caption="The nightly data-quality summary posted to Slack"
  aspect="16/9"
/>
...
- **Isolation.** Each run executes in its own microVM sandbox, and only the
  HubSpot and enrichment changes it's explicitly allowed to make leave the
  sandbox.
...
<Figure
  caption="A bulk field update held at the approval gate before it writes"
  aspect="16/9"
/>
