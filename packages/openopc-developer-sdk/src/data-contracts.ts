...
export const OpenOpcModuleDocumentDeleteResultSchema = z.object({ ok: z.literal(true) }).strict();
export type OpenOpcModuleDocumentDeleteResult = z.infer<
  typeof OpenOpcModuleDocumentDeleteResultSchema
>;
